...
function drawRow(employee) {
    ...
    row.append($('<td>'
        + '<span class="small-button delete"><button>delete</button></span>' + '<span class="employeeDel" employeeId="' + employee.employeeId + '">'
        + '<span class="small-button edit"><button>edit</button></span>' + '<span class="employeeEdit" employeeId="' + employee.employeeId + '">'));
}